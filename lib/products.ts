...
export const products: Product[] = [
  ...
  },
  {
    ...
    short_description:
      "A professional swing trading workstation for Indian and American markets, bringing scanners, watchlists, advanced charting, broker workflows, alerts, and portfolio review into one place.",
    image: {
    ...
    description:
      "Imperium Investor is a desktop swing trading app for traders who want Indian and American market workflows in a single workstation. It helps active traders move from idea discovery to chart validation to disciplined execution, combining scanner-driven discovery, tabbed watchlists, professional charting, broker-aware order workflows, live positions, stop-loss management, alerts, news, portfolio intelligence, and performance review for positions held from days to weeks.",
    promise:
      "Track Indian stocks and American market opportunities from one focused swing trading workstation.",
    badges: ["India + U.S. markets", "American investing", "Swing trading"],
    highlights: [
      {
        icon: "/usa.svg",
        title: "American market focus",
        text: "Built to make U.S. stock discovery, chart review, watchlists, and swing-trade planning feel native inside Imperium.",
      },
      {
        icon: "/india.svg",
        title: "Indian market mode",
        text: "Keep Indian-market watchlists, charts, broker workflows, positions, and review tools in the same workstation.",
      },
      {
        icon: "/portfolio.svg",
        title: "One portfolio workspace",
        text: "Use one command center for scanners, multi-timeframe charts, alerts, stop-loss management, portfolio intelligence, and trade review.",
      },
    ],
    gallery: [
      {
        ...
        caption: "American stock workflows are a main focus: scan, chart, watch, plan, and review U.S. opportunities in one terminal.",
        width: 1364,
        height: 767,
      },
      {
        ...
        caption: "Switch into Indian-market swing trading without leaving the same charting, watchlist, and review environment.",
        width: 1364,
        height: 767,
      },
      {
        src: "/product-resources/imperium-investor/Imperium_investor.png",
        alt: "Imperium Investor desktop swing trading workstation overview",
        title: "Swing trading command center",
        caption: "Keep scanner discovery, chart validation, broker workflows, alerts, and portfolio context in one desktop workspace.",
        width: 1672,
        height: 941,
      },
    ],
    ...
    audience: [
      ...
      "Indian traders who want a dedicated workflow for American market investing",
    ...
    includes: [
      "Indian and American market modes inside one desktop workstation",
      "U.S. stock investing workflows for discovery, chart validation, watchlists, and portfolio review",
