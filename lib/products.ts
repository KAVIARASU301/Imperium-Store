...
export const products: Product[] = [
  {
    ...
    gallery: [
      ...
      },
      {
        ...
        caption: "Price and cumulative volume delta across multiple symbols in dedicated monitor windows.",
        width: 1365,
        height: 767,
      },
      {
        ...
        title: "CPR scanner",
        caption: "Ranked post-market stock ideas, ready for the next session's watchlist.",
        width: 979,
        height: 559,
      },
    ],
