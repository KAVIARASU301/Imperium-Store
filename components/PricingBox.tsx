    ...
    return (
        <aside className="surface-panel overflow-hidden">
            ...
            <div className="p-4 sm:p-5">
                <div className="rounded-md border border-cyan-border bg-section p-3 shadow-[0_0_0_1px_rgba(255,255,255,0.06)_inset] sm:p-4">
                    <p className="font-mono text-[11px] font-semibold uppercase tracking-wider text-muted">
                        Payable amount
                    </p>
                    <p className="mt-2 text-white">
                        <span className="mr-1 align-baseline text-base font-semibold sm:text-xl">
                            {formatCurrencySymbol(currency)}
                        </span>
                        <span className="font-sans text-3xl font-extrabold tracking-normal tabular-nums sm:text-4xl">
                ...
                <p className="mt-4 hidden rounded-md border border-cyan-border bg-card px-3 py-2 text-xs font-medium leading-5 text-muted sm:block">
                    {ready
