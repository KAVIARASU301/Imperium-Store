...
export default function ProductImage({ product, priority = false, className = "" }: { product: Product; priority?: boolean; className?: string }) {
  return (
    <figure className={`border border-cyan-border bg-section shadow-2xl shadow-black/30 ${className}`}>
      ...
      <div className="bg-main p-2 md:p-3">
        <Image
      ...
      <figcaption className="grid gap-px bg-cyan-border font-mono text-[10px] uppercase tracking-[0.16em] text-muted sm:grid-cols-3">
