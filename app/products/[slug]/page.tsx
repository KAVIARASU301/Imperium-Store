    ...
    <main className="mx-auto max-w-6xl px-6 py-16">
      <div className="grid gap-10 lg:grid-cols-[1fr_360px]">
        <section>
          ...
          <div className="mt-10"><TerminalPreview /></div>
        ...
        <div className="lg:sticky lg:top-8 lg:self-start"><PricingBox price={product.price} currency={product.currency} slug={product.slug} /></div>
      </div>
    </main>
  );
}
