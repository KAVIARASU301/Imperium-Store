  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      <section className="border border-[#1b3055] bg-[#0c1525] p-6">
        <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em] text-[#0891b2]">Customer desk</p>
        <h1 className="mt-3 text-4xl font-bold text-[#c5d5ee]">Support</h1>
